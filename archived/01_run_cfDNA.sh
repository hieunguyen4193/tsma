...
parallel -j 100 'python 01_collect_reads_from_BAM.py --region {} --output ./datadir/readdf_cfDNA --metadata metadata.csv --sample_type cfDNA --bamdir '$bamdir ::: $regions;
echo $region_file_split >> finished_split_regions_cfDNA.txt;done