...
parallel -j 250 'python 02_conduct_ttest_one_class_versus_others.py --region {} --output ./outputdir_02102023 --metadata metadata.csv --LOO_sample not_given --atlas_sample_types Tissue,Control' ::: $regions;done;
